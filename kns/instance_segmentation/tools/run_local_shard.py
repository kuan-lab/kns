...
from kns.instance_segmentation.config import load_config, get_stage_config
from kns.instance_segmentation.stages.segmentation_stage import _process_block   
from kns.instance_segmentation.state.checkpoint import mark_local_done, is_local_done
from kns.instance_segmentation.utils.meta_utils import save_block_meta
...
def main():
    ...
    metadata_dir   = stage_cfg.get("metadata_dir", "kns/local_metadata")
