...
from kns.instance_segmentation.utils.meta_utils import load_index_meta
from kns.instance_segmentation.utils.block_utils import intersect_boxes_zyx
from kns.instance_segmentation.utils.relabel_utils import (
    accumulate_local_global_pairs,
    update_id_pools,               # For optional memory aggregation only
    build_rep_map_from_pools,      # Optional
)
from kns.instance_segmentation.utils.relabel_utils import select_pairs 
...
def _overlap_union_task(
    ...
    min_overlap_vox, min_frac_local, min_frac_global, require_recip, allow_union_amb, dom_ratio, min_iou = thresholds_pack
